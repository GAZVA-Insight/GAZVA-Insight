/* ==========================================================================
  ...
  // ← Add this: injects theme-color on every page automatically
  if (!document.querySelector('meta[name="theme-color"]')) {
    const themeMeta = document.createElement("meta");
    themeMeta.name = "theme-color";
    themeMeta.content = "#1B7A6E";
...
(function () {
  ...
  const NAV_LINKS = [
    ...
    { href: "globalaffairs.html", label: "Global Affairs" },
...
`;
 ...
 function buildFooter() {
  ...
  footer.innerHTML = `
    <div class="footer__top">
      ...
      <div class="footer__col footer__col--brand">
        ...
        <p class="footer__tagline">Cultivating thoughtful minds through authentic Islamic knowledge.
</p>
  ...
  <svg width="16" height="16"
   ...
   <a href="https://www.facebook.com/p/Fathima-Zahra-Islamic-Womens-College-Chemmad-Students-Union-GAZVA-100071198438474/"
   class="footer__social-btn"
   aria-label="Facebook"
   target="_blank"
   rel="noopener">
  ...
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <div class="footer__bottom">
      <div class="footer__bottom-inner">
        <span>&copy; <span id="footerYear">${new Date().getFullYear()}</span> GAZVA Insight. GAZVA - FZIWC Chemmad.</span>
  ...
  function buildAskSidebar() {
    ...
    wrap.innerHTML = `
      ...
      <p class="ask-sidebar__desc">Have a question about Islamic knowledge, contemporary issues, or any topic we cover? Send it to our editorial team—we'd love to hear from you.</p>
      <form id="askQuestionForm" novalidate>
        ...
        <select id="askq-category" name="category" required>
          ...
          <option value="Ahkaam">Ahkaam</option>
          <option value="Siyar">Siyar</option>
          <option value="Reflection">Reflection</option>
          <option value="Global Affairs">Global Affairs</option>
          <option value="Bookshelf">Bookshelf</option>
          <option value="Meet the Scholar">Meet the Scholar</option>
          <option value="Kurippathukal">Kurippathukal</option>
